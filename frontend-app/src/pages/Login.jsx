...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    if (!accountNumber.trim() || !phone.trim()) {
      setError("Account number aur phone dono required hain.");
      return;
    }

    if (pin.length !== 4) {
      setError("4-digit PIN daalo.");
      return;
    }
      ...
      >
        <div className="login-card-inner">
          ...
          <form className="login-form" onSubmit={handleLogin}>
            ...
            <div className="field-row">
              <div className="field">
                ...
                <input
                  type="text"
                  inputMode="numeric"
                  placeholder="16-digit virtual account"
                  value={accountNumber}
            ...
            <div className="login-footer-row">
              <button
                ...
                onClick={() =>
                  alert(
                    "Forgot PIN flow (OTP + reset) baad mein backend ke saath wire karenge."
                  )
                }
              >
                Forgot PIN?
          ...
          <div className="login-footer">
            ...
            <p className="login-hint">
              Demo ke liye koi bhi virtual user ka <strong>accountNumber + phone + PIN</strong> daalo.
            </p>
          </div>
        </div>
      </div>
