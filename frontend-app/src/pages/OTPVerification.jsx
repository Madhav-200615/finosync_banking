    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            if (transferData.billType === "loan" && transferData.loanId) {
                ...
                recipientName = loanRes.data?.loan?.loanType
                    ? `${loanRes.data.loan.loanType} Loan`
                    : transferData.accountHolder || "Loan EMI";
                recipientAccount = "Loan Account";
            } else {
            ...
            navigate("/payments/result", {
                state: {
                    ...
                    amount: transferData.amount,
                    recipient: transferData.accountHolder
                }
            });
        }
    };
