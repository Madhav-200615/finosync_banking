...
const creditScoreRoute = require("./src/routes/creditScore");
const otpRoutes = require("./src/routes/otp");            // ⭐ NEW OTP ROUTES
...
app.use("/api/sip", require("./src/routes/sip"));
app.use("/api/ipo", require("./src/routes/ipo.routes"));
app.use("/api/nps", require("./src/routes/nps.routes"));
app.use("/api/gold", require("./src/routes/gold.routes"));
app.use("/api/apy", require("./src/routes/apy.routes"));
// Prometheus metrics
